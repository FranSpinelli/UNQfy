...
describe ('ApiCaller tests', () => {
  ...
  /*it('un ApiCaller puede testear el estado del accessToken de spotify', function(){

    return apicaller.probarYActualizarConexionSpotify().then( data => {

      assert.notEqual("BQA5ToReAcgj_ZO2vETtXtxKlP3oA0ncSwewUIW0KNW3OgJr6FYoJCpEe3MsaPK9Erktc9h2klcqc37_iTKH0Rn0dsuWSSitPW9UpyK1WNEsILznb6MJ4Guxw26HgOaDCO5PHcNn1eBsUxajzgYaEcWXkJSh1LRCPuo77BscjMNvkOF3RQ", spotifyCreds.access_token);
    })
  })*/
